...
export const mockQuests: Quest[] = [
  ...
  },
  {
    id: "quest_squats_20",
    title: "20 приседаний",
    description: "Короткая физическая перезагрузка. Сделай 20 чистых повторений без паузы.",
    category: "body",
    difficulty: "easy",
    xpReward: 100,
    durationMinutes: 5,
  ...
  },
  {
    ...
    description: "Выбери задачу до 15 минут и доведи её до статуса готово.",
    category: "work",
    difficulty: "medium",
    xpReward: 160,
    durationMinutes: 15,
...
export const mockBadges: Badge[] = [
  { id: "founder", title: "Основатель", description: "Первый набор LOCKIN" },
  { id: "streak_7", title: "7 дней", description: "Неделя без пропусков" },
  { id: "focus", title: "Фокус", description: "Фокус-квесты закрыты" },
  { id: "team", title: "Командный игрок", description: "Командный x2 XP" },
  { id: "early", title: "Ранний доступ", description: "Вошёл в первый круг LOCKIN" },
];
...
export const mockCharacterBuild: CharacterBuild = {
  ...
  nextUnlock: "Flow State через 4 фокус-proof",
  stats: [
    {
      id: "focus",
      label: "Фокус",
    ...
    },
    {
      ...
      level: 2,
      progress: 44,
      description: "Движение, прогулки, короткие физические перезагрузки.",
    },
    {
      id: "social",
      label: "Squad",
  ...
  skills: [
    ...
    },
    {
      ...
      branch: "core",
      status: "locked",
      requirement: "21 день серии",
      bonus: "золотая карточка",
    },
    {
      id: "focus_deep_work",
      ...
      branch: "focus",
      status: "unlocked",
      requirement: "3 фокус-proof",
      bonus: "+12% XP за фокус",
    },
    {
      id: "focus_phone_lock",
      title: "Блок телефона",
    ...
    },
    {
      ...
      branch: "focus",
      status: "locked",
      requirement: "10 фокус-proof",
      bonus: "x1.5 XP за фокус",
    },
    {
      id: "squad_signal",
      title: "Сигнал squad",
